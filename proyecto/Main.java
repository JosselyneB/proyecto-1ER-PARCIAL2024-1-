...
public class Main {
    public static void main(String[] args) {
        // Crear un cliente
        Cliente cliente = new Cliente("Jorman Vinces", "1315555530", "0978736850");

        // Crear un vehículo
        Vehiculo vehiculo = new Vehiculo("PKK-0990", "Zusuki", "Forza II", cliente);
        ...
        System.out.println("Monto a pagar: $" + String.format("%.2f", totalAPagar)); // Formatear el monto a dos decimales
